...
class RunText(SampleBase):
    ...
    def Run(self):
        ...
        while True:
            ...
            i = 1
            lenAB = graphics.DrawText(offscreenCanvas, fontBig, posA+12, 11, textTop[i][1], textTop[i][0])
            i = 2
            lenAC = graphics.DrawText(offscreenCanvas, fontBig, posA+24, 11, textTop[i][1], textTop[i][0])

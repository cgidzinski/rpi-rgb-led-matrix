        ...
        ##############
            for pr in prs:
                ...
                if len(pr['labels']) != 0:
                    ...
                    graphics.DrawText(offscreenCanvas, fontBig, 58+(8*len(pr['labels'][0])), 12, green,txtLen)
                ...
                graphics.DrawText(offscreenCanvas, fontBig, 2188888888-(8*len(pr['user'])),12 , blue ,pr['user'] )
